...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # Autoriser le serveur de développement React
    "http://127.0.0.1:3000",
]
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "myapp.apicrud.serializers.MyTokenObtainPairSerializer",
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER= os.environ.get('EMAIL_HOST_USER', config.get('DEFAULT', 'EMAIL_HOST_USER', fallback=''))
EMAIL_HOST_PASSWORD= os.environ.get('EMAIL_HOST_PASSWORD', config.get('DEFAULT', 'EMAIL_HOST_PASSWORD', fallback=''))
